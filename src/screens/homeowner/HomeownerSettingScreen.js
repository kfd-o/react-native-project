...
import { View, Text, Pressable, TouchableOpacity, useColorScheme, TouchableWithoutFeedback } from 'react-native';
...
const HomeownerSettingScreen = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.containerSettings}>
                <TouchableOpacity style={styles.themeOption} onPress={() => navigation.navigate('HomeownerAccountScreen')}>
                    <View style={styles.themeOptionIcon}>
                        <MaterialCommunityIcons name='account' size={hp('2%')} color={styles.iconColor} />
                        <Text style={styles.optionText}>Account</Text>
                    </View>
                    <View >
                        <MaterialIcons name={'keyboard-arrow-right'} size={hp('2.4%')} color={styles.iconColor} />
                    </View>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.containerSettings}>
                <TouchableOpacity style={styles.themeOption} onPress={handleLight}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: wp('5%') }}>
                        <MaterialIcons name='light-mode' size={hp('2%')} color={styles.iconColor} />
                        <Text style={styles.optionText}>Light</Text>
                    </View>
                    <View >
                        <MaterialIcons name={selectedTheme === 'light' ? 'radio-button-checked' : 'radio-button-unchecked'} size={hp('2%')} color={styles.iconColor} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.themeOption} onPress={handleDark}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: wp('5%') }}>
                        <MaterialIcons name='dark-mode' size={hp('2%')} color={styles.iconColor} />
                        <Text style={styles.optionText}>Dark</Text>
                    </View>
                    <View >
                        <MaterialIcons name={selectedTheme === 'dark' ? 'radio-button-checked' : 'radio-button-unchecked'} size={hp('2%')} color={styles.iconColor} />
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.themeOption} onPress={handleSystem}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: wp('5%') }}>
                        <MaterialIcons name='contrast' size={hp('2%')} color={styles.iconColor} />
                        <Text style={styles.optionText}>System</Text>
                    </View>
                    <View >
                        <MaterialIcons name={selectedTheme === 'system' ? 'radio-button-checked' : 'radio-button-unchecked'} size={hp('2%')} color={styles.iconColor} />
                    </View>
                </TouchableOpacity>
            </View>
            <View>
...
export default HomeownerSettingScreen;
