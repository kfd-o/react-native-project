...
import { View, Text, StyleSheet, Image, Pressable, TouchableOpacity, Alert, FlatList, Linking, ScrollView } from 'react-native';
...
const HouseDetailScreen = ({ route, navigation }) => {
    const { model, description, bedroom, bathroom, carport, floor_area, lot_area, price, img_url, id } = route.params;
    ...
    const renderImageItem = ({ item, index }) => (
        <Pressable onPress={() => { setCurrentImageIndex(index); setIsImageViewVisible(true); }}>
            <Image
    ...
    return (
        <View style={styles.container}>
            <View style={{ height: hp('40%'), position: 'relative' }}>
                <Pressable style={{ position: 'absolute', zIndex: 2, left: 10, top: 10 }} onPress={() => navigation.goBack()}>
                    <MaterialIcon name='arrow-back' size={30} color='white' style={{ borderRadius: 50, backgroundColor: 'rgba(0,0,0,.4)', padding: 5 }} />
                </Pressable>
                <Image source={{ uri: img_url }} style={{ width: '100%', height: hp('35%'), resizeMode: 'stretch' }} />
            ...
            <ScrollView style={styles.detailsContainer}>
                ...
                <View style={styles.featuresContainer}>
                    <View style={styles.featureItem}>
                        <MaterialCommunityIcon name='floor-plan' size={25} color='#5D6D7E' />
                ...
                <View>
                    ...
                    <View style={styles.contactContainer}>
                        ...
                        <TouchableOpacity onPress={() => openURL('fb-messenger://user-thread/100067924101081')}>
                            <MaterialCommunityIcon name='facebook-messenger' size={hp('3.4%')} color='#5D6D7E' />
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => openURL('mailto:samplecasareal@gmail.com')}>
