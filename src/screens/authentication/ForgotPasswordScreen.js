...
import { View, Text, StyleSheet, TextInput, Alert, Keyboard, TouchableWithoutFeedback, KeyboardAvoidingView, ScrollView, TouchableOpacity } from 'react-native';
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={[styles.views, styles.two]}>
                            <View style={styles.inputContainer}>
                                <TextInput
                                    style={[styles.textInput, emailExistError && { borderWidth: 1, borderColor: '#B22222' }]}
                                    placeholder='Email'
                                    placeholderTextColor={emailExistError ? '#DC143C' : '#85929E'}
                        ...
                        {emailExistError && (
                            <View style={styles.errorContainer}>
                                <MaterialIcons name="warning" size={13} color='#DC143C' />
