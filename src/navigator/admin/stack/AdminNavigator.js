...
const AdminNavigator = () => (
    <Stack.Navigator>
        ...
        <Stack.Screen name="HomeownerListsScreen" component={HomeownerListsScreen} options={{ headerShown: false }} />
        <Stack.Screen name="SecurityPersonnelListsScreen" component={SecurityPersonnelListsScreen} options={{ headerShown: false }} />
        <Stack.Screen name="VisitorListsScreen" component={VisitorListsScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AccountScreen" component={AccountScreen} options={{ headerShown: false }} />
        <Stack.Screen name="AddHomeScreen" component={AddHomeScreen} options={{ headerShown: false, animation: 'slide_from_bottom' }} />
        <Stack.Screen name="SignupHomeownerScreen" component={SignupHomeownerScreen} options={{ headerShown: false, animation: 'slide_from_bottom' }} />
        <Stack.Screen name="SignupSecurityPersonnelScreen" component={SignupSecurityPersonnelScreen} options={{ headerShown: false, animation: 'slide_from_bottom' }} />
        <Stack.Screen name="QRCodeScannerScreen" component={QRCodeScannerScreen} options={{ headerShown: false, animation: 'slide_from_bottom' }} />
        <Stack.Screen name="SampleHouse" component={SampleHouse} options={{ headerShown: false, animation: 'slide_from_bottom' }} />
